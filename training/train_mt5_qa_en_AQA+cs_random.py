...
training_arguments = AdaptationArguments(output_dir="train_dir_AQA_random_large",
...
qa_train = qa_en["train"].filter(lambda entry: len(entry["context"]) < 800)
...
squad_cs_dataset = json.load(open("training/data/czech_squad_4-sents.json"))
